  ...
  return (
    <header className='absolute w-full z-50 transition-all duration-300'>
        <div className='container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 md:h-20'>
            ...
            className='ml-4 px-4 py-2 rounded-xl bg-gradient-to-r from-gray-400 to-gray-100 text:violet-700
            font-bold hover:from-violet-700 hover:to-purple-700 hover:text-white transform-all duration-500'>
                Hire Me
            </motion.button>
        ...
        {/* MOBILE MENU  */}
            ...
            <AnimatePresence>
               ...
               {contactFormOpen && (
                 ...
                 exit={{ opacity:0}}
                 transition={{ duration: 0.5}}
                 className='fixed inset-0 bg-black/50 background-blur-sm z-50 flex items-center justify-center
                 p-4'
                 ...
                 >
                    ...
                    <form className='space-y-4'>
                        ...
                        from-violet-600 to-violet-400 hover:from-violet-700 hover:to-purple-700
                        trasition0all duration-300 rounded-lg shadow-md hover:shadow-violet-600/50'>
                            Send Message
                        </motion.button>
